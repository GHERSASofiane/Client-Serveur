...
//**********************************************************************************************************************************************
//**********************************************************************************************************************************************
void *thread_recev_commandes(void *arg){

     while(TRUE){

        char buf_recev[800]="";
        char Buf_Param[800] ="";
        int v = read(sock,buf_recev,500);
...
//**** LES VARIABLE RECU 
        ...
        gtk_builder_add_from_file (builder_principale, "Window/Main.glade", NULL);
...
//******** signal pour valider le plateau   ****************************************************************************************
       ...
       g_signal_connect ( gtk_builder_get_object (builder_principale, "Validate"),
                           "clicked", G_CALLBACK (Validate_tray), (GtkWidget*) pVBox_tray );
...
//******** lancer la bare de temps    ****************************************************************************************
        ...
        //******** lancer le thread d'attend les commandes    ****************************************************************************************
         if(pthread_create(&Thread_Recev_Commandes, NULL, thread_recev_commandes, NULL) == -1) { }
